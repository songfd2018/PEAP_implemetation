...
phenotype_names <- c("Basal", "Her2", "LumA", "LumB", "Normal")
n_pheno <- 5
...
for(i in 1:n_pairs){
  ...
  if(i %% 1000 == 0)
    print(paste0("Finish computing the FC of the first ",i," gene pairs..."))
}

colnames(fc_gp) <- c("fc.Basal", "fc.Her2", "fc.LumA", "fc.LumB", "fc.Normal")
